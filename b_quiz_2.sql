...
-- 資料庫： `b_quiz_2`
--
CREATE DATABASE IF NOT EXISTS `b_quiz_2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `b_quiz_2`;
...
INSERT INTO `b_quiz_2_news` (`id`, `title`, `text`, `type`, `good`, `sh`) VALUES
...
INSERT INTO `b_quiz_2_que` (`id`, `text`, `count`, `subject_id`) VALUES
...
('root', '[{\"db\":\"b_quiz_2\",\"table\":\"b_quiz_2_news\"},{\"db\":\"b_quiz_2\",\"table\":\"b_quiz_2news\"},{\"db\":\"b_quiz_2\",\"table\":\"b_quiz_2_que\"},{\"db\":\"b_quiz_2\",\"table\":\"b_quiz_2que\"},{\"db\":\"b_quiz_2\",\"table\":\"b_quiz_2_total\"},{\"db\":\"b_quiz_2\",\"table\":\"b_quiz_2total\"},{\"db\":\"b_quiz_2\",\"table\":\"b_quiz_2_user\"},{\"db\":\"b_quiz_2\",\"table\":\"b_quiz_2user\"},{\"db\":\"b_quiz_2\",\"table\":\"user\"},{\"db\":\"b_quiz_2\",\"table\":\"total\"}]');
...
('root', '2022-08-01 00:20:04', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"zh_TW\"}');
